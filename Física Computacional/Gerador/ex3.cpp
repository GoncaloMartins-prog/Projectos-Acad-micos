...
{
	ofstream outfile;
	long long int N = 2000; // dimensao// 100//1000
	...
	outfile.open("Valores normalizados.txt");
	for(int i = 1; i < N; i++)
 	{
	...
	outfile.open("Quantidades em cada intervalo.txt");
 	for( int j = 0; j < k; j++)
 	{
